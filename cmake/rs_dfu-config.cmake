...
set(_rs_dfu_shared_lib "${RS_DFU_LIB_DIR}/${_rs_dfu_lib_prefix}rs_dfu.${_rs_dfu_shared_ext}")
set(_rs_dfu_static_lib "${RS_DFU_LIB_DIR}/${_rs_dfu_lib_prefix}rs_dfu.${_rs_dfu_static_ext}")

# Create imported targets
if(EXISTS "${_rs_dfu_shared_lib}" AND NOT TARGET rs_dfu::shared)
    add_library(rs_dfu::shared SHARED IMPORTED)
    set_target_properties(rs_dfu::shared PROPERTIES
        IMPORTED_LOCATION "${_rs_dfu_shared_lib}"
...
if(NOT TARGET rs_dfu::rs_dfu)
    if(TARGET rs_dfu::shared)
        add_library(rs_dfu::rs_dfu ALIAS rs_dfu::shared)
    elseif(TARGET rs_dfu::static)
